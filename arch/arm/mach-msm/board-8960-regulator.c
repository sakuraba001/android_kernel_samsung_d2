...
#if defined(CONFIG_MACH_M2) || defined(CONFIG_MACH_APEXQ) || defined(CONFIG_MACH_ESPRESSO_VZW) || defined(CONFIG_MACH_EXPRESS) || defined(CONFIG_MACH_M2_DCM) || defined(CONFIG_MACH_M2_KDI)
